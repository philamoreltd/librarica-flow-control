...
ALTER TABLE public.reservations ADD COLUMN department_id UUID REFERENCES public.reservations(id);
...
DO $$ BEGIN
    CREATE TYPE public.user_role AS ENUM ('super_admin', 'department_admin', 'librarian', 'teacher', 'student', 'inactive_student');
EXCEPTION
    WHEN duplicate_object THEN null;
END $$;

-- Update profiles table to use enum and add department admin role
